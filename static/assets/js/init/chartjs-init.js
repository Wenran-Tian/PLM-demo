...
( function ( $ ) {
    ...
    /*
    $.ajax({
        url:"/chart-chartjs-dataload/",
        type:'GET',
        dataType:'JSON',
        success:function (data) {
            saleschartdata0 = data.values ;
            alert(saleschartdata0);
    ...
    //         datasets: [ {
    //             label: "Grocery",
    //             // data: [ 0, 0, 15, 110, 50, 63, 23, 23, 55],
    //             // data: [ 0, 0, 15, 110, 50, 63, 23, 23, 55],
    ...
    //     }
    // } );
    // // myChart.datasets.data = saleschartdata0;
    //
    //
    // //line chart
